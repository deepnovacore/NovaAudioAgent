...
Executable examples for the launch-profile and decision tables live in
[`approval-examples-0.152.0.json`](../../../fixtures/codex/approval-examples-0.152.0.json).
`runtime/test/codex-protocol-pin.test.ts` validates them against the generated snapshot.
