...
export function normalizeSettings(raw, base = DEFAULT_SETTINGS) {
  ...
  return {
    ...
    codexProjectsEnabled: pick(
      ownEnumerableDataValue(source, 'codexProjectsEnabled'),
      ownEnumerableDataValue(fallback, 'codexProjectsEnabled'),
      DEFAULT_SETTINGS.codexProjectsEnabled,
      validBoolean,
    ),
    codexWorkspace: pick(
...
export function publicSettings(settings) {
  ...
  return {
    ...
    codexProjectsEnabled: normalized.codexProjectsEnabled,
...
export function applySettingsUpdate(current, patch, codec) {
  ...
  const next = normalizeSettings({
    ...
    codexProjectsEnabled: ownEnumerableDataValue(source, 'codexProjectsEnabled'),
