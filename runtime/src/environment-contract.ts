...
const rows: readonly Row[] = [
  ...
  ['NOVA_AUDIO_AGENT_SEARCH_MCP_URL', 'search', false, true, 'never', null, 'Web search MCP endpoint.', '网页搜索 MCP 地址。'],
  ['NOVA_AUDIO_AGENT_SEARCH_MCP_TOOL', 'search', false, true, 'never', 'web_search', 'Web search MCP tool name.', '网页搜索 MCP 工具名。'],
